...
void main() {
  ...
  List<List<double>> rawData = [[10, 50], [20, 30], [30, 40]];
  ...
  print('Current KNN Accuracy: ${EvaluationMetrics.accuracyScore(y_true_clf, y_pred_clf)}');
  ...
  print('Regression MSE: ${EvaluationMetrics.meanSquaredError(y_fore, y_pred_reg)}');
  print('Regression R2 Score: ${EvaluationMetrics.r2Score(y_fore, y_pred_reg)}');
}
